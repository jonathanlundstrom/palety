...
return [
    ...
    */
    ...
    'ascii' => ':Attribute får bara innehålla enbyte alfanumeriska tecken och symboler.',
    ...
    'doesnt_end_with' => ':Attribute får inte sluta med följande värden: :values.',
    ...
    'password' => [
        ...
        'mixed' => ':Attribute måste innehålla minst en liten och en stor bokstav.',
        'numbers' => ':Attribute måste innehålla minst en siffra.',
        'symbols' => ':Attribute måste innehålla minst en symbol.',
        'uncompromised' => 'Det angivna :attribute återfinns i läckta källor på internet. Byt :attribute så fort som möjligt.',
    ],
    ...
    'prohibited_if_declined' => 'Fältet :attribute är förbjudet när :other avvisas.',
    'prohibited_unless' => ':Attribute är förbjudet om inte :other är :values.',
    'prohibits' => 'Fältet :attribute förhindrar :other från att ha ett värde.',
    ...
    'required_if_declined' => 'Fältet :attribute är obligatoriskt när :other avvisas.',
    ...
    'phone' => 'Fältet :attribute måste vara ett giltigt telefonnummer.',
